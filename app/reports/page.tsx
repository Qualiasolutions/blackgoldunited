...
const quickReports = [
  { title: 'Daily Sales Summary', href: '/reports/sales/daily-summary' },
  { title: 'Monthly P&L Statement', href: '/reports/accounting/profit-loss' },
  { title: 'Employee Attendance', href: '/reports/employee/attendance' },
  { title: 'Inventory Status', href: '/reports/store/inventory-status' },
  { title: 'Client Payment Status', href: '/reports/clients/payments' }
]
